...
func getGeneralBlocking() []model.Target {
	return []model.Target{
		...
		// DISCORD - Core connectivity checks (Updated)
		{ID: "US.DSC-MAIN", Provider: "🇺🇸 Discord Main", Times: 1, URL: "https://discord.com", Threshold: model.DefaultWebThreshold},
		{ID: "US.DSC-API", Provider: "🇺🇸 Discord API", Times: 1, URL: "https://discord.com/api/v10/gateway", Threshold: 50},                                                     // JSON response
		{ID: "US.DSC-GW", Provider: "🇺🇸 Discord Gateway", Times: 1, URL: "https://gateway.discord.gg", Threshold: model.DefaultWebThreshold, IgnoreStatus: true},                // WS endpoint often returns 404 on HTTP but connection proves unblocked
		{ID: "US.DSC-CDN", Provider: "🇺🇸 Discord CDN", Times: 1, URL: "https://cdn.discordapp.com/attachments/0/0/0", Threshold: model.DefaultWebThreshold, IgnoreStatus: true}, // CDN check

		{ID: "US.DSC-Q01", Provider: "🇺🇸 Discord QUIC", Times: 1, URL: "https://discord.com", Threshold: model.DefaultWebThreshold, Proto: "quic"},
		{ID: "US.DSC-Q02", Provider: "🇺🇸 Discord QUIC GW", Times: 1, URL: "https://gateway.discord.gg", Threshold: model.DefaultWebThreshold, Proto: "quic", IgnoreStatus: true},
