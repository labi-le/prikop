...
func init() {
	registerProvider(types.ProviderDefinition{
		...
		Targets: []types.Target{
			{URL: "https://j.dejure.org/jcg/doctrine/doctrine_banner.webp", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},
			{URL: "https://accesorioscelular.com/tienda/css/plugins.css", Threshold: 162646, IgnoreStatus: true},
			{URL: "https://251b5cd9.nip.io/1MB.bin", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},
			...
			{URL: "https://5fd8bdae.nip.io/1MB.bin", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},

			{URL: "https://nbg1-speed.hetzner.com/100MB.bin", Threshold: DefaultThreshold, IgnoreStatus: false, Proto: types.ProtoTCP}, // Nuremberg, DE
			{URL: "https://fsn1-speed.hetzner.com/100MB.bin", Threshold: DefaultThreshold, IgnoreStatus: false, Proto: types.ProtoTCP}, // Falkenstein, DE
