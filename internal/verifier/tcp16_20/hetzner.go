...
func init() {
	registerProvider(newTCPProvider("hetzner",
		"https://raw.githubusercontent.com/123jjck/cdn-ip-ranges/refs/heads/main/hetzner/hetzner_plain_ipv4.txt",
		[]types.Target{
			...
			{URL: "https://ash-speed.hetzner.com/100MB.bin", Threshold: DefaultThreshold, IgnoreStatus: false, Proto: types.ProtoTCP},
		},
	))
}
