...
func init() {
	registerProvider(types.ProviderDefinition{
		...
		Targets: []types.Target{
			...
			{URL: "https://ping.online.net/1Mo.dat", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},
			{URL: "http://elec-martin.fr/", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},
			{URL: "https://www.moobicom.ci/assets/slider1.jpg", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},
			{URL: "https://laboratoire-ccd.com", Threshold: DefaultThreshold, IgnoreStatus: true, Proto: types.ProtoTCP},
		},
	})
}
